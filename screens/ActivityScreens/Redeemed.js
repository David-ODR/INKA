  ...
  getlist = async () => {
    ...
    navigator.geolocation.getCurrentPosition(
      position => {
        ...
        fetch(`http://Inkafoodapp.com/Api/Consumer/Coupon/Redeemed/${position.coords.longitude},${position.coords.latitude}/${this.state.range}?Country=Philippines`,
          {
            headers: {
          ...
          ListEmptyComponent={() =>
            (
              <View style={{ flex: 1, justifyContent: "center", alignItems: "center", width: screenwidth, height: 200 }}>
                ...
                <Subheading>No Redeemed Coupons</Subheading>
              </View>
            )}
          renderItem={({ item }) => (
