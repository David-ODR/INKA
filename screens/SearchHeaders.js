...
export default class SearchHeaders extends React.Component {
  ...
  render() {
    if (this.props.pageview === "Deals")
      return (
        <Appbar.Header>
          <Appbar.Action icon="filter-list" onPress={() => this.props.navigation.openDrawer()} />
          ...
          <Appbar.Action icon="add-location" onPress={() => console.log('Pressed mail')} />
        </Appbar.Header>
      );
    if (this.props.pageview === "Merchants")
      return (
        <Appbar.Header>
